...
Ext.require([
 	'Ushine.base.TopFrame1',
	'Ushine.base.CenterFrame1',
	'Ushine.base.Menu1',
	...
	return {
		...
		init: function() {
			...
			Ext.viewport = new Ext.container.Viewport({
				...
				autoScroll:false,
				items: [
					new Ushine.base.TopFrame1(), 
					Ext.create('Ushine.base.CenterFrame1')
				]
			});
		}
