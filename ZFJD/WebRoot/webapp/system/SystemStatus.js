Ext.define('Ushine.system.SystemStatus', {
    ...
    constructor:function(){
    	...
    	this.items={
                ...
                items: [{
                    ...
                    items: [
                        me.createCpu1LoadChart(me),
                        me.createCpu2LoadChart(me)
                    ]
                }, {
                    flex: 1,
                    xtype: 'container',
                    ...
                    items: [
                        me.createMemoryPieChart(me),
                        me.createProcessChart(me)
                    ]
                }]
            };
    	this.callParent(); 
    },
    createCpu1LoadChart: function (me) {
        return {
            flex: 1,
            xtype: 'chart',
            theme: 'Category1',
            animate: false,
            store: me.cpuLoadStore,
            legend: {
                position: 'bottom'
            },
            axes: [{
    ...
    createCpu2LoadChart: function (me) {
        return {
            flex: 1,
            xtype: 'chart',
            theme: 'Category2',
    ...
    createMemoryPieChart: function (me) {
        var me = this;
    ...
    createProcessChart: function (me) {
        return {
            flex: 1,
            xtype: 'chart',
            theme: 'Category1',
            store: me.processesMemoryStore,
            animate: {
                easing: 'ease-in-out',
                duration: 750
            },
